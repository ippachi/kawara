...
export default function GoogleSignupButton({ className }: React.ComponentProps<'div'>) {
  return <div className={classNames(className, "bg-[#4285f4] text-gray-100 hover:text-white shadow font-bold text-sm py-3 px-4 rounded flex justify-start items-center cursor-pointer w-64")}>
